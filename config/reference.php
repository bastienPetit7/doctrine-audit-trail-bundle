 ...
 *     },
 * }
 * @psalm-type DoctrineAuditTrailConfig = array{
 *     enabled?: bool|Param, // Global kill switch: when false, no audit entry is written. // Default: true
 *     storage?: array{
 *         entity_manager?: scalar|Param|null, // Name of the dedicated entity manager holding audit logs. // Default: "audit"
 *         table_name?: scalar|Param|null, // Table name for the audit trail entity. // Default: "audit_trail"
 *     },
 *     ignored_fields?: list<scalar|Param|null>,
 *     actor?: array{
 *         fallback_label?: scalar|Param|null, // Label used outside an HTTP request (CLI, messenger). // Default: "cli"
 *         user_resolver?: scalar|Param|null, // Custom AuditUserResolverInterface service id (optional). // Default: null
 *     },
 * }
 ...
 *     doctrine_audit_trail?: DoctrineAuditTrailConfig,
